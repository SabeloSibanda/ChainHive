    ...
    return (
        <>
            <LayoutAdmin
                headTitle="Dashboard"
                // pageTitle="Dashboard"
                pageTitleSub={"ChainHive Dashboard"}
                pageClass={"admin"}
                parent={"Home"}
                child={"Dashboard"}
            >
                <div className="row">
                        ...
                        <div className="promotion d-flex justify-content-between align-items-center">
                            <div className="promotion-detail">
                                <h3 className="text-white mb-3">
                                    Discover, Connect with, and Work
                                    with Awesome Freelancers
                                </h3>
                                <p>
                                    Digital marketplace for crypto developers
                                    on multiple chains
                                </p>
                                <a className="btn btn-primary me-3">Explore</a>
                                <a className="btn btn-secondary">Connect</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-8 col-xl-12">
                        <h4 className="card-title mb-3">Top Developers</h4>
                        <div className="card">
                    ...
                    <div className="col-xl-12">
                        <h4 className="card-title mb-3">Recent Projects </h4>
